...
import peter.spring.web.board.BoardVO;
...
public class DispatcherServlet extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		//2. HandlerMapping을 통해 path에 해당하는 컨트롤러를 검색한다
...
//		//프래임워크 사용 전 방법
//		//2.클라이언트 요청 path에 따라 적절히 작업을 분기 시켜준다.
...
//			//3. 화면 내비게이션
//			if(user!=null){
//				response.sendRedirect("getBoardList.do"); //로그인 성공
//			} else {
