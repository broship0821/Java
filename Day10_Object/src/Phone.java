...
public class Phone {
	...
	/*
	 생성자(constructor)
	 	...
	 	1. 생성자는 객체를 생성하는 역활을 하며, 그렇기 때문에
	 	클래스 내부에 반드시 하나 이상 존재하여야 된다.
	...
	/*
	 생성자 오버로딩(생성자 중복선언)
	 	...
	 	1. 생성자는 중복해서 여러개 선언이 가능
	 	
	 	2. 단, 생성자의 매개변수의 타입, 갯수, 순서 중 하나가 달라야 중복이 인정됨
